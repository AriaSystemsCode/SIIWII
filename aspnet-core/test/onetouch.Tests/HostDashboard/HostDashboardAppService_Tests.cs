...
using onetouch.MultiTenancy.HostDashboard;
...
namespace onetouch.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(onetouchDbContext context, SubscriptionPayment subscriptionPayment)
        {
