...
$webHostFolder = Join-Path $slnFolder "src/onetouch.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/onetouch.Web.Public"
...
(Get-Content $ngConfigPath) -replace "4214", "9902" | Set-Content $ngConfigPath
