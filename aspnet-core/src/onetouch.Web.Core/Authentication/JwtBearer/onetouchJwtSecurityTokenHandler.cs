...
namespace onetouch.Web.Authentication.JwtBearer
{
    public class onetouchJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public onetouchJwtSecurityTokenHandler()
        {
