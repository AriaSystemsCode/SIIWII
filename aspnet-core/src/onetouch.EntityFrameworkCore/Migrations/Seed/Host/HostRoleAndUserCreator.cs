...
namespace onetouch.Migrations.Seed.Host
{
    ...
    where T : class, IEntity<long>
      ...
      r => r.Code == "TENANTACTIVITYLOG");
            ...
            var names = "Transaction Charges,Charge Types,Background,Product Variation,Product,Listing Variation,Listing,Category,Department,Classification,Branch,BUSINESS,Group,Personal,Size Scale,Sales Order,Purchase Order,Ship Via,Standard Feature,Standard Subscription Plan,Tenant Activity Log,Unit Of Measurement,AR Invoice,Message,Comment,Review,Question,Marketplace Section Type,Marketplace Section,Marketplace Block Type,Marketplace Section Block,Person follow Business,Person join Group,Person follow Person,Business hire Person,Business join Group,Business follow Business,Group invite Person,Group invite Business,Marketplace Contact Relationship,Sell to this Buyer,Connect to this Sales agent,Sell to this Buying Office,Buy from this Seller,Buy from this Sales agent,Connect to this Buying agent,Sell on behalf of this Seller,Sell to this Buyer,Connect to this Buying agent,Buy from this Seller,Buy on behalf this Buyer,Connect to this Sales agent,Group follow Group".Split(',');
