...
{
    /// <inheritdoc />
    public partial class RenamePriceLevelTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppMarketplaceAccountsPriceLevels",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMarketplaceAccountsPriceLevels", x => x.Id);
                });
        }
