...
{
    /// <inheritdoc />
    public partial class I40MarketplaceAccounts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SSIN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMarketplaceContacts_AppEntities_EntityId",
                        column: x => x.EntityId,
                        principalTable: "AppEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMarketplaceContacts_AppMarketplaceContacts_AccountId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMarketplaceContacts_AppMarketplaceContacts_PartnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMarketplaceContacts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMarketplaceContacts_EntityId",
                table: "AppMarketplaceContacts",
                column: "EntityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMarketplaceContacts_PartnerId",
                table: "AppMarketplaceContacts",
                column: "PartnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMarketplaceContacts_TenantId",
                table: "AppMarketplaceContacts",
                column: "TenantId");
        }
