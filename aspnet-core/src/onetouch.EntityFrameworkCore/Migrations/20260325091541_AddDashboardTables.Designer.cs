...
namespace onetouch.Migrations
{
    ...
    [Migration("20260325091541_AddDashboardTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("onetouch.AppDashboard.AppDashboard", b =>
                {
                    b.HasBaseType("onetouch.AppEntities.AppEntity");
                    ...
                    b.ToTable("AppDashboards", t =>
                        {
                            t.HasTrigger("AppDashboards_Trigger");
                        });
                });

            modelBuilder.Entity("onetouch.AppDashboard.AppDashboardCard", b =>
                {
                    b.HasBaseType("onetouch.AppEntities.AppEntity");

                    b.Property<long>("AppDashboardId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AppDashboardId");

                    b.ToTable("AppDashboardCards", t =>
                        {
                            t.HasTrigger("AppDashboardCards_Trigger");
                        });
                });
            ...
            modelBuilder.Entity("onetouch.AppDashboard.AppDashboard", b =>
                {
                    b.HasOne("onetouch.AppEntities.AppEntity", null)
                        .WithOne()
                        .HasForeignKey("onetouch.AppDashboard.AppDashboard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("onetouch.AppDashboard.AppDashboardCard", b =>
                {
                    b.HasOne("onetouch.AppDashboard.AppDashboard", "AppDashboardFk")
                        .WithMany()
                        .HasForeignKey("AppDashboardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("onetouch.AppEntities.AppEntity", null)
                        .WithOne()
                        .HasForeignKey("onetouch.AppDashboard.AppDashboardCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppDashboardFk");
                });
