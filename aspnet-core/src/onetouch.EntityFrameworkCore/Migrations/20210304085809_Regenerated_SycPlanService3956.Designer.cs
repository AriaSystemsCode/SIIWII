...
namespace onetouch.Migrations
{
    ...
    [Migration("20210304085809_Regenerated_SycPlanService3956")]
    partial class Regenerated_SycPlanService3956
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("onetouch.AppTenantsActivitiesLogs.AppTenantsActivitiesLog", b =>
                {
                    ...
                    b.Property<int?>("SycApplicationId")
                        .HasColumnType("int");

                    b.Property<int?>("SycServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SycApplicationId");

                    b.HasIndex("SycServiceId");
            ...
            modelBuilder.Entity("onetouch.AppEntities.AppEntityExtraData", b =>
                {
                    b.HasOne("onetouch.SystemObjects.SydObject", "AttributeFk")
                        .WithMany()
            ...
            modelBuilder.Entity("onetouch.AppTenantPlans.AppTenantPlan", b =>
                {
                    b.HasOne("onetouch.SycPlans.SycPlan", "SycPlanFk")
                        .WithMany()
                        .HasForeignKey("SycPlanId");
                });

            modelBuilder.Entity("onetouch.AppTenantsActivitiesLogs.AppTenantsActivitiesLog", b =>
                {
                    b.HasOne("onetouch.AppTransactions.AppTransaction", "AppTransactionFk")
                        .WithMany()
                        .HasForeignKey("AppTransactionId");

                    b.HasOne("onetouch.SycApplications.SycApplication", "SycApplicationFk")
                        .WithMany()
                        .HasForeignKey("SycApplicationId");

                    b.HasOne("onetouch.SycServices.SycService", "SycServiceFk")
                        .WithMany()
                        .HasForeignKey("SycServiceId");
                });
