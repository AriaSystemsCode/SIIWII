...
using onetouch.Core.Base;
using onetouch.Core.Extensions;
using onetouch.Dto;
using onetouch.Types;

namespace onetouch.Queries
{
    public class OrganizationUnitQuery : onetouchQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
