...
using onetouch.Auditing.Exporting;
using onetouch.Authorization;
using onetouch.Authorization.Users;
using onetouch.Dto;
using onetouch.EntityHistory;
using EntityHistoryHelper = onetouch.EntityHistory.EntityHistoryHelper;

namespace onetouch.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : onetouchAppServiceBase, IAuditLogAppService
    {
