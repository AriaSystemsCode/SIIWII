        ...
        //MMT22
        {
            ...
            try
            {
                ...
                //if (files != null && files.Length > 0)
                {
                    ...
                    // accountExcelResultsDTO.AccountExcelLogDTO.AccountExcelLogPath = @"https://localhost:44316/" + accountExcelResultsDTO.FilePath.Replace(_appConfiguration[$"Attachment:Omitt"].ToString().ToUpper(), "");
