...
namespace onetouch.AppMarketplaceAccounts
{
    ...
    public class AppMarketplaceAccountsAppService : onetouchAppServiceBase, IAppMarketplaceAccountsAppService, IExcelImporter<AppMarketplaceAccountExcelResultsDTO>
    {
        ...
        public AppMarketplaceAccountsAppService(IRepository<AppMarketplaceContact, long> appContactRepository
