    ...
    public class AppTenantActivitiesLogAppService : onetouchAppServiceBase, IAppTenantActivitiesLogAppService
    {
        ...
        public async Task<PagedResultDto<GetAppTenantActivityLogForViewDto>> GetAll(GetAllAppTenantActivitiesLogInput input)
        {
            ...
            var filteredAppTenantActivitiesLog = _appTenantActivityLogRepository.GetAll()
                        ...
                        e.TenantName.ToUpper().Contains(input.Filter.ToUpper()) ||
                        e.ActivityType.ToUpper().Contains(input.Filter.ToUpper()) || 
                        e.AppSubscriptionPlanCode.ToUpper().Contains(input.Filter.ToUpper()) ||
                        e.UserName.ToUpper().Contains(input.Filter.ToUpper()) ||
                        e.FeatureCode.ToUpper().Contains(input.Filter.ToUpper()) ||
                        e.FeatureName.ToUpper().Contains(input.Filter.ToUpper()) || 
                        e.Reference.ToUpper().Contains(input.Filter.ToUpper()) || 
                        e.InvoiceNumber.ToUpper().Contains(input.Filter.ToUpper()) || 
