...
namespace Abp.Localization
{
    ...
    public static class MultiTenantLocalizationDictionaryCacheHelper
    {
        ...
        public static ITypedCache<string, Dictionary<string, string>> GetMultiTenantLocalizationDictionaryCache2(this ICacheManager cacheManager)
        {
            return cacheManager.GetCache(CacheName).AsTyped<string, Dictionary<string, string>>();
        }

        public static string CalculateCacheKey2(int? tenantId, string sourceName, string languageName)
        {
