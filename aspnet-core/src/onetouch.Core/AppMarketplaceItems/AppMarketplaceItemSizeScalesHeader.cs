...
namespace onetouch.AppMarketplaceItems
{
    ...
    [Audited]
    public class AppMarketplaceItemSizeScalesHeader : FullAuditedEntity<long>
    {
        ...
        [ForeignKey("ParentId")]
        public AppMarketplaceItemSizeScalesHeader ItemSizeScaleFK { get; set; }
        public virtual ICollection<AppMarketplaceItemSizeScalesDetails> AppItemSizeScalesDetails { get; set; }
