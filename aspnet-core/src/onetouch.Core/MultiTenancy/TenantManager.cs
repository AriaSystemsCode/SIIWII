...
namespace onetouch.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task<int> CreateWithAdminUserAsync(
            ...
            string emailActivationLink, int? inviterTenantId, string firstName,string lastName, int relatedTenantId = 0)
        {
            int newTenantId;
            long newAdminId;
            ...
            using (var uow = _unitOfWorkManager.Begin(TransactionScopeOption.RequiresNew))
            {
                ...
                using (_unitOfWorkManager.Current.SetTenantId(tenant.Id))
                {
                    ...
                    var adminUser = User.CreateTenantAdminUser(tenant.Id, adminEmailAddress,tenancyName,firstName, lastName, relatedTenantId);
