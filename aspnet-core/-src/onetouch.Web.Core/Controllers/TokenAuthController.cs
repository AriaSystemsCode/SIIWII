...
using onetouch.Authentication.TwoFactor.Google;
...
using onetouch.Web.Models.TokenAuth;
...
using onetouch.Net.Sms;
using onetouch.Notifications;
using onetouch.Security.Recaptcha;
using onetouch.Web.Authentication.External;
...
namespace onetouch.Web.Controllers
{
    ...
    public class TokenAuthController : onetouchControllerBase
    {
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            //MMT, 10/11/2022 T-SII-20220906.0002 - Application language not setup correctly[Start]
            await SettingManager.ChangeSettingForUserAsync(
            new Abp.UserIdentifier(AbpSession.TenantId, loginResult.User.Id),
           LocalizationSettingNames.DefaultLanguage,
            Thread.CurrentThread.CurrentUICulture.Name);
            //MMT, 10/11/2022 T-SII-20220906.0002 - Application language not setup correctly[End]
