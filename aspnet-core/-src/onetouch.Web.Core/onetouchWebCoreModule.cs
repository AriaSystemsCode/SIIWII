...
using onetouch.Web.Authentication.JwtBearer;
using onetouch.Web.Authentication.TwoFactor;
using onetouch.Web.Chat.SignalR;
using onetouch.Web.Configuration;
using onetouch.Web.DashboardCustomization;

namespace onetouch.Web
{
    [DependsOn(
        typeof(onetouchApplicationModule),
        typeof(onetouchEntityFrameworkCoreModule),
    ...
    public class onetouchWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public onetouchWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(onetouchApplicationModule).GetAssembly()
                );
            ...
            Configuration.Caching.Configure(TwoFactorCodeCacheItem.CacheName, cache =>
            {
                ...
                cache.DefaultSlidingExpireTime = TimeSpan.FromMinutes(2);
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(onetouchWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(onetouchWebCoreModule).Assembly);
        }
