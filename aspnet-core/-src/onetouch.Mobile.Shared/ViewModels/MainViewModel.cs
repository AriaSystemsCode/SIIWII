...
using onetouch.Commands;
using onetouch.Core.Threading;
using onetouch.Models.NavigationMenu;
using onetouch.Services.Navigation;
...
using onetouch.ApiClient;
using onetouch.Controls;
using onetouch.Dto;
using onetouch.Extensions;
using onetouch.Localization;
using onetouch.UI;
using onetouch.UI.Assets;
using onetouch.Views;
using DependencyResolver = onetouch.Core.Dependency.DependencyResolver;
...
namespace onetouch.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "onetouch";
