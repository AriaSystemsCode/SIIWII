...
{
    public class SubscriptionPaymentExtensionDataRepository : onetouchRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<onetouchDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
