...
{
    public class SubscriptionPaymentRepository : onetouchRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<onetouchDbContext> dbContextProvider)
