...
namespace onetouch.Migrations
{
    ...
    [Migration("20200726120248_Add_AppMessagesTable")]
    partial class Add_AppMessagesTable
    {
            ...
            modelBuilder.Entity("onetouch.AppContacts.AppAddress", b =>
                {
                    ...
                    b.Property<string>("CountryIdCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("onetouch.AppContacts.AppContact", b =>
                {
                    ...
                    b.Property<string>("CurrencyIdCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LanguageIdCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PartnerIdCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Phone1TypeIdName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Phone2TypeIdName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Phone3TypeIdName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("SycEntityObjectStatusId")
                        .HasColumnType("int");

                    b.Property<int>("SycEntityObjectTypeId")
                        .HasColumnType("int");

                    b.Property<int>("SydObjectId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SycEntityObjectStatusId");

                    b.HasIndex("SycEntityObjectTypeId");

                    b.HasIndex("SydObjectId");
            ...
            modelBuilder.Entity("onetouch.AppContacts.AppContactAddress", b =>
                {
                    ...
                    b.Property<string>("AddressIdCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long>("AddressTypeId")
                        .HasColumnType("bigint");

                    b.Property<string>("AddressTypeIdCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long>("ContactId")
                        .HasColumnType("bigint");

                    b.Property<string>("ContactIdCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("onetouch.AppEntities.AppEntityAttachment", b =>
                {
                    ...
                    b.Property<string>("AttachmentCategoryIdCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long>("AttachmentId")
                        .HasColumnType("bigint");

                    b.Property<string>("AttachmentIdCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("onetouch.AppEntities.AppEntityCategory", b =>
                {
                    ...
                    b.Property<int>("EntityObjectCategoryId")
                        .HasColumnType("int");

                    b.Property<string>("EntityObjectCategoryIdCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("onetouch.AppEntities.AppEntityClassification", b =>
                {
                    ...
                    b.Property<int>("EntityObjectClassificationId")
                        .HasColumnType("int");

                    b.Property<string>("EntityObjectClassificationIdCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SycAttachmentCategory", b =>
                {
                    ...
                    b.Property<int?>("EntityObjectTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SycEntityObjectCategory", b =>
                {
                    ...
                    b.Property<string>("SydObjectIdCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SydObject", b =>
                {
                    ...
                    b.Property<int>("SysObjectTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("onetouch.AppContacts.AppContact", b =>
                {
                    ...
                    b.HasOne("onetouch.SystemObjects.SycEntityObjectStatus", "SycEntityObjectStatusFk")
                        .WithMany()
                        .HasForeignKey("SycEntityObjectStatusId");

                    b.HasOne("onetouch.SystemObjects.SycEntityObjectType", "SycEntityObjectTypeFk")
                        .WithMany()
                        .HasForeignKey("SycEntityObjectTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("onetouch.SystemObjects.SydObject", "SydObjectFk")
                        .WithMany()
                        .HasForeignKey("SydObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SydObject", b =>
                {
                    ...
                    b.HasOne("onetouch.SystemObjects.SysObjectType", "SysObjectTypeFk")
                        .WithMany()
                        .HasForeignKey("SysObjectTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
