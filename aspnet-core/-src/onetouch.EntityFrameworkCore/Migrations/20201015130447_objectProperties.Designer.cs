...
namespace onetouch.Migrations
{
    ...
    [Migration("20201015130447_objectProperties")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SydObjectProperty", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ObjectRevisionId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("PropertySettings")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ObjectRevisionId");

                    b.HasIndex("PropertyId");

                    b.HasIndex("PropertyTypeId");

                    b.ToTable("SydObjectProperties");
                });

            modelBuilder.Entity("onetouch.SystemObjects.SydObjectRevision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SysObjectTypeProperty", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("SysObjectTypeProperties");
                });

            modelBuilder.Entity("onetouch.SystemObjects.SysPropertyType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SydObjectProperty", b =>
                {
                    ...
                    b.HasOne("onetouch.SystemObjects.SydObjectRevision", "ObjectRevisionFk")
                        .WithMany()
                        .HasForeignKey("ObjectRevisionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("onetouch.SystemObjects.SysObjectTypeProperty", "PropertyFk")
                        .WithMany()
                        .HasForeignKey("PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("onetouch.SystemObjects.SysPropertyType", "PropertyTypeFk")
                        .WithMany()
