...
namespace onetouch.Migrations
{
    ...
    [Migration("20230410141600_AddSSINIDToSydobjectTable3")]
    partial class AddSSINIDToSydobjectTable3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SydObject", b =>
                {
                    ...
                    b.Property<long?>("SSINIdentifier")
                        .HasColumnType("bigint");

                    b.Property<string>("SSINIdentifierCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("SycDefaultIdentifierCode")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("onetouch.SystemObjects.SydObject", b =>
                {
                    ...
                    b.HasOne("onetouch.SycIdentifierDefinitions.SycIdentifierDefinition", "SSINIdentifierFk")
                        .WithMany()
                        .HasForeignKey("SSINIdentifier");

                    b.HasOne("onetouch.SycIdentifierDefinitions.SycIdentifierDefinition", "SycIdentifierDefinitionIdFk")
                        .WithMany()
                        .HasForeignKey("SycIdentifierDefinitionId");
                    ...
                    b.Navigation("SSINIdentifierFk");

                    b.Navigation("SycIdentifierDefinitionIdFk");
                });
