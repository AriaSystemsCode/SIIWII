...
namespace onetouch.Migrations
{
    ...
    [Migration("20200604143603_Add_table_AppEntitiesAndAppContacts_CodeNullable")]
    partial class Add_table_AppEntitiesAndAppContacts_CodeNullable
    {
            ...
            modelBuilder.Entity("onetouch.AppContacts.AppContact", b =>
                {
                    ...
                    b.HasOne("onetouch.AppEntities.AppEntity", "ParentFk")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("onetouch.SystemObjects.SycEntityObjectType", "PartnerFk")
                        .WithMany()
