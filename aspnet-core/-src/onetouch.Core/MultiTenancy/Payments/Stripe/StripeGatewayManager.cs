...
{
    public class StripeGatewayManager : onetouchServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "onetouch";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + onetouchConsts.Currency;
        }
