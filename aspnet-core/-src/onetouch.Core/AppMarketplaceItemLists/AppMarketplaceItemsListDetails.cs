...
namespace onetouch.AppMarketplaceItemLists
{
    ...
    public class AppMarketplaceItemsListDetails : Entity<long>
    {
        public virtual long AppMarketplaceItemsListId { get; set; }

        [ForeignKey("AppMarketplaceItemsListId")]
        public AppMarketplaceItemLists ItemsListFK { get; set; }
        ...
        public AppMarketplaceItems.AppMarketplaceItems ItemFK { get; set; }
