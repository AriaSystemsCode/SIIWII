...
namespace onetouch.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : onetouchServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("onetouch", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
