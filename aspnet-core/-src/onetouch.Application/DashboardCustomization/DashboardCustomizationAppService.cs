...
using onetouch.DashboardCustomization.Definitions;
using onetouch.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace onetouch.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : onetouchAppServiceBase, IDashboardCustomizationAppService
    {
