...
namespace onetouch.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : onetouchAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<onetouchDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{onetouchConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{onetouchConsts.ConnectionStringName}", constring);
        }
