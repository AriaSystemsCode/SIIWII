...
using onetouch.Url;
using onetouch.Web.Public.Startup;
using onetouch.Web.Session;

namespace onetouch.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : onetouchViewComponent
    {
