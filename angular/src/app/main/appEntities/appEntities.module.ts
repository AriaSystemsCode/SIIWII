...
import { AppEntitiesRoutingModule } from './appEntities-routing.module';
...
@NgModule({
  declarations: [AppEntitiesComponent,ViewAppEntityModalComponent,CreateOrEditAppEntityModalComponent],
  imports: [
    CommonModule,
    AppEntitiesRoutingModule,
    AppCommonModule,
    FormsModule,
    ReactiveFormsModule,
    ModalModule.forRoot(),
