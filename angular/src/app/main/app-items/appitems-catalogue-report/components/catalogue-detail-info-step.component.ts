...
export class CatalogueDetailInfoStepComponent extends AppComponentBase implements OnInit {
  ...
  getbackgrounds() {
    this.backgrounds = [];
    this._appEntitiesServiceProxy.getAllBackgroundWithPaging(undefined, undefined, undefined, undefined, undefined,true, "BACKGROUND", undefined, undefined, undefined
