...
@Component({
    templateUrl: './appSubscriptionPlanDetails.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class AppSubscriptionPlanDetailsComponent extends AppComponentBase {
    
    
    @ViewChild('entityTypeHistoryModal', { static: true }) entityTypeHistoryModal: EntityTypeHistoryModalComponent;
    @ViewChild('createOrEditAppSubscriptionPlanDetailModal', { static: true }) createOrEditAppSubscriptionPlanDetailModal: CreateOrEditAppSubscriptionPlanDetailModalComponent;
    @ViewChild('viewAppSubscriptionPlanDetailModalComponent', { static: true }) viewAppSubscriptionPlanDetailModal: ViewAppSubscriptionPlanDetailModalComponent;   
    ...
    createAppSubscriptionPlanDetail(): void {
        this.createOrEditAppSubscriptionPlanDetailModal.show();        
    }
