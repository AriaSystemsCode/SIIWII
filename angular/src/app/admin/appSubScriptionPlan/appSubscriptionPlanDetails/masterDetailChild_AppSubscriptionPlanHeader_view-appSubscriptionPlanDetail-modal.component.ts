...
@Component({
    selector: 'masterDetailChild_AppSubscriptionPlanHeader_viewAppSubscriptionPlanDetailModal',
    templateUrl: './masterDetailChild_AppSubscriptionPlanHeader_view-appSubscriptionPlanDetail-modal.component.html'
})
export class MasterDetailChild_AppSubscriptionPlanHeader_ViewAppSubscriptionPlanDetailModalComponent extends AppComponentBase {
