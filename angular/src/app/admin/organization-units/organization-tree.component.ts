...
export class OrganizationTreeComponent extends AppComponentBase implements OnInit {
    ...
    nodeDrop(event) {
        ...
        var isConfirmed: Observable<boolean>;
          var message =  this.l('OrganizationUnitMoveConfirmMessage', event.dragNode.data.displayName, dropNodeDisplayName);
    ...
    private getContextMenuItems(): any[] {
        ...
        let items = [
            ...
            },
            {
                ...
                command: () => {
                    var isConfirmed: Observable<boolean>;
          var message = this.l('OrganizationUnitDeleteWarningMessage', this.selectedOu.data.displayName);
          isConfirmed   = this.askToConfirm(message,"AreYouSure");
