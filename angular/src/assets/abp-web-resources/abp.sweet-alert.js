...
(function () {
    var showMessage = function (type, message, title, options) {
        ...
        options.title = title;
        options.type = type;
        options.confirmButtonText = options.confirmButtonText || abp.localization.localize('Ok', 'onetouch');
    ...
    abp.message.confirm = function (message, title, callback, options) {
        options = options || {};
        options.title = title ? title : abp.localization.localize('AreYouSure', 'onetouch');
        options.type = 'warning';

        options.confirmButtonText = options.confirmButtonText || abp.localization.localize('Yes', 'onetouch');
        options.cancelButtonText = options.cancelButtonText || abp.localization.localize('Cancel', 'onetouch');
